...
When generating mermaid code blocks, use Mermaid v11 syntax rules (see mermaid.js.org docs for v11).
...
For `--slides`: recommend using theonekit-web UI/UX design patterns for richer style selection (if installed).
Use Mermaid v11 syntax for any Mermaid diagrams.
